...
> **하단 예시 디렉토리 구조**
> ![directory 구조](({{ site.url }}/assets/images/posts/xdebug/directory.png "directory 구조")
...
#### Step 4
extension install
![extension](({{ site.url }}/assets/images/posts/xdebug/extension.png "extension")

#### Step 5
launch.json 생성
![launch.json](({{ site.url }}/assets/images/posts/xdebug/launch.png "launch")
...
![디버그 실행](({{ site.url }}/assets/images/posts/xdebug/debug.png "debug")